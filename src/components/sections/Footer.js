  ...
  return (
    <StyledFooterRoot ref={footer}>
      ...
      >
        {lg && (
          <StyledFooterList>
            <StyledListItemLink
              ...
              href="https://www.linkedin.com/in/sriharsha-srungavarapu/"
              target="_blank"
            >
              <svg
            ...
            <StyledListItemLink
              href="https://github.com/iharshuu"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <StyledListItemLink
              href="mailto:harshalmten@gmail.com"
        ...
        <StyledFooterText>Developed by Sriharsha</StyledFooterText>
