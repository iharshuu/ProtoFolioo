      ...
      <StyledHeroContainer ismobile={isMobile}>
        <StyledHeroGrid ismobile={isMobile} container spacing={0}>
          <Grid item style={{ paddingLeft: "0 !important" }}>
            <StyledHeroImage alt="Image of Sriharsha Srungavarapu" src={img} />
          </Grid>
          <StyledHeroText item>
            <StyledHeroTitle component="h1" variant="h2">
              Sriharsha Srungavarapu
            </StyledHeroTitle>
            <StyledHeroSubText component="h1" variant="h5">
              Full stack software engineer who enjoys creative coding
            </StyledHeroSubText>
            <div>
            <img
            src="https://www.goodtecher.com/wp-content/uploads/2020/08/LeetCode_logo-300x300.png"
            ...
            onclick="location.href='https://leetcode.com/iharshu/'"
          />
        </div>
          </StyledHeroText>
        </StyledHeroGrid>
